...
<body class=""style="background-color: #7e16a3;">
      ...
      <div class="card-body ">
        ...
        <form class="mx-3 user"  role="form" method="POST" action="{{ route('login') }}">
          ...
          <div class="from-group">
            ...
            <div class="input-group mb-3 ">
              <span class="input-group-text icon-dalam"><i class="fas fa-lock" style="color: #460e5b;"></i></span>
          ...
          <button type="submit" class="btn btn-primary col-12 mt-3"
            style="background-color: #460e5b;color: #000; font-weight: bold;border-width: 0%;">LOGIN</button>
        </form>
        <p class="mt-3 mb-0 text-white text-center" style="font-size: smaller;">Don't have an account ? <a href="{{ route('register')}}"
            style="color: #460e5b;text-decoration: none;">Sign Up</a></p>
      </div>
    </div>
  </div>
